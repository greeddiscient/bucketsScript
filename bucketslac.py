...
sc30=player("John", "Wall", "Washington Wizards", "was", 2,["White Home","Alternate Navy Blue"])
kt11=player("Bradley", "Beal", "Washington Wizards", "was", 3,["White Home","Alternate Navy Blue"])
...
with open("was.csv", "wb") as csv_file:
