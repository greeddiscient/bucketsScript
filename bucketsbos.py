...
sc30=player("Isaiah", "Thomas", "Boston Celtics", "bos", 4,["White Home","Green (White)","Black Green"])
kt11=player("Jaylen", "Brown", "Boston Celtics", "bos", 7,["White Home","Green (White)","Black Green"])
dg23=player("Jae", "Crowder", "Boston Celtics", "bos", 99,["White Home","Green (White)","Black Green"])
kd35=player("Al", "Horford", "Boston Celtics", "bos", 42,["White Home","Green (White)","Black Green"])
# ai09=player("Tristan", "Thompson", "Cleveland Cavaliers", "cle", 13,["White Home","Red Wine","Alternate Gold","Christmas '16'"])


with open("bos.csv", "wb") as csv_file:
