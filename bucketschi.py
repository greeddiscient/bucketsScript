...
sc30=player("Dwayne", "Wade", "Chicago Bulls", "min", 3,["White Home","Red Away"])
kt11=player("Jimmy Butler", "Towns", "Chicago Bulls", "min", 21,["White Home","Red Away"])
dg23=player("Rajon", "Rondo", "Chicago Bulls", "min", 9,["White Home","Red Away"])
...
with open("chi.csv", "wb") as csv_file:
